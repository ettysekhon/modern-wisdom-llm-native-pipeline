...
def client(url: str | None = None, api_key: str | None = None) -> QdrantClient:
    """Create QdrantClient - delegates to qdrant_ops.client for proper Fly.io handling."""
    from .qdrant_ops import client as ops_client

    return ops_client(url=url, api_key=api_key)
